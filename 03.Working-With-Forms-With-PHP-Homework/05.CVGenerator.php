...
if (isset($_POST['firstName'], $_POST['lastName'], $_POST['email'], $_POST['phone'],
    $_POST['gender'], $_POST['birthday'], $_POST['nationality'], $_POST['company'],
    $_POST['fromDate'], $_POST['toDate'], $_POST['progLang'],
    $_POST['progLangLevel'], $_POST['lang'], $_POST['comprehension'],
    $_POST['reading'], $_POST['writing'])):
    ...
    if (filter_var($firstName, FILTER_VALIDATE_REGEXP, $nameLangPattern) ||
        ...
        strlen($firstName) < 2 || strlen($firstName) > 20 ||
        strlen($lastName) < 2 || strlen($lastName > 20)) {
        die ('First Name and Last Name must contain only letters between 2 and
        20 symbols!');
    }
    ...
    if (filter_var($company, FILTER_VALIDATE_REGEXP, $companyPattern) ||
        ...
        die ('Company Name must contain only letters and numbers between 2 and
        20 symbols!');
    }
